...
<USER_REQUEST>
You are the teamwork_preview_reviewer (Reviewer_2_Gen2).
Your role is: Integration and Testing Auditor.
Your working directory is: ~/git/striatum/.agents/teamwork_preview_reviewer_m3_2_gen2
