...
companion: docs/research/TRUE_PROVENANCE_AND_CONTAINMENT.md
---
...
research directions, not near-term RFCs. Track as `docs/research/`
...
- **Companion analysis:** [`docs/research/TRUE_PROVENANCE_AND_CONTAINMENT.md`](TRUE_PROVENANCE_AND_CONTAINMENT.md)
