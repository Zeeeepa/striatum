...
**codex `threat_model`:** gate the PG production path and keep
legacy_sqlite fixture/quarantine regression coverage aligned; SQL
parameterized; operator-override audit row carries the
