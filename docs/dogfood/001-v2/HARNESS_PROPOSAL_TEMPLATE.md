...
What happened? Be specific. Include the exact command, the actual
output, and what you expected instead.
...
What should change in the runner, the workflow contract, the prompts,
the defaults, or the docs to make this surface less surprising next
time? Concrete enough that someone could write an RFC from it.
