# Synthesize Design Prompt (Two-Lane Retry)

Produce `docs/dogfood/030/DESIGN_SYNTHESIS.md` with valid `striatum.synthesis.v1` front matter.

Read the Codex and Claude Code design artifacts from this run and synthesize one implementation plan. The synthesis must explicitly reconcile RFC 0026 and RFC 0027 rather than treating them as unrelated changes.
