...
| [postgres-transition.md](how-to/postgres-transition.md) | Operator | The D094 / RFC 0043 PostgreSQL runbook: prerequisites, daemon doctor role/grant repair, daemon service startup, `striatum adopt`, native PostgreSQL adoption verification, and exit codes 11 / 12. |
