...
| [0037](0037-web-ui-ergonomic-improvements.md) | proposed | Web UI ergonomic polish over the RFC 0013/0022/0023/0024 base: run-list filter + duration column; workflows-index filter + last-modified; doctor problem grouping + terminal-run hide toggle; localtime toggle; graph-node hover tooltips; keyboard shortcuts (g r / g w / g c / g d / ?); app.css dark-mode parity; next-actions panel promotion; empty-state copy. No new runtime deps, no SPA conversion, no visual redesign. |
