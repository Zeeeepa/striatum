# RFC 0052: Striatum Corpus Contract V2
...
RFC 0044 V1 shipped the first Striatum corpus export. RFC 0052 names the V2
...
- Implementing the Engram side. RFC 0052 is a Striatum-side contract. The
...
- Promoting Engram from an optional augmentation consumer to a runtime
  dependency. RFC 0052 cannot land in a shape that breaks the augmentation
...
This section enumerates the V2 decisions that RFC 0052 must answer before it
...
2. Should the contract live in `docs/rfcs/0052-corpus-contract-v2.md` plus
