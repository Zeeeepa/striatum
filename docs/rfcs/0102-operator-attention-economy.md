...
Status: proposed (lever-1 realized indirectly; lever-2 attention-view folded — D219, #396: no net-new attention verb, the `dashboard --run-id`/`--once` + blocking-frontier reads serve the Track-2 frame)
Date: 2026-05-31
