...
| `recovery requeue-stale` | `recovery.requeue_stale` | recovery | replaced_by_mcp_ui | mcp_exact | ui_exact | tests/test_mcp_mutation_capabilities.py::test_mcp_tools_call_exact_workflow_control_methods_route_to_daemon_rpc, tests/test_service.py::test_v1_invoke_existing_ui_gap_routes_daemon_rpc_not_api_invoke | blocked_retirement_test_gap |
...
| `decision record` | `decision.record` | admin | replaced_by_mcp_ui | mcp_exact | ui_exact | tests/test_mcp_mutation_capabilities.py::test_mcp_tools_call_exact_workflow_control_methods_route_to_daemon_rpc, tests/test_service.py::test_v1_invoke_existing_ui_gap_routes_daemon_rpc_not_api_invoke | blocked_retirement_test_gap |
