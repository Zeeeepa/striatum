...
- Read all three design proposals under
  `docs/operator/workflows/rfc-0098-adjudicated-constraint-extraction/artifacts/design/`, then publish a
  single synthesis at
...
- Call out unresolved contradictions and how the build phase should handle
  ...
  (default RFC 0098 slice 1 — `collaboration_ledger.v1.1` + the
