...
- Write only to your lane's allowed path under
  `docs/operator/workflows/rfc-0098-adjudicated-constraint-extraction/artifacts/design/<lane>/`.
- Produce a single `DESIGN.md` covering problem framing, a proposed
  approach (sliced smallest-blast-radius first), alternatives considered,
  risks/unknowns, and a rollout sketch.
