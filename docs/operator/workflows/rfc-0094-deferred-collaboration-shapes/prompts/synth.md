...
`docs/operator/workflows/rfc-0094-deferred-collaboration-shapes/artifacts/design/`. Produce a single
...
- List the smallest implementable scope a single implementer can land next
  (default: RFC 0094 slice 1, `post_dialog_hook` + `synaptic_prune`; pull in
  slice 2 only if it stays reviewable).

Do not edit files under
`docs/operator/workflows/rfc-0094-deferred-collaboration-shapes/artifacts/design/`. Do not write
source code.
