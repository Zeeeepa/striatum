...
- Read `docs/operator/workflows/rfc-0094-deferred-collaboration-shapes/artifacts/DESIGN_SYNTHESIS.md`
...
- Write
  `docs/operator/workflows/rfc-0094-deferred-collaboration-shapes/artifacts/build/HANDOFF.md` with
