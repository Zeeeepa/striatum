...
`docs/operator/workflows/rfc-0089-tmux-helper-redesign/artifacts/design/`.

Write one buildable synthesis at
`docs/operator/workflows/rfc-0089-tmux-helper-redesign/artifacts/DESIGN_SYNTHESIS.md`.
