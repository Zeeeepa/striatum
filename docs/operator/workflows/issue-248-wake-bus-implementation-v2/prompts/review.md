...
- Treat any edits to the tainted reference scaffold at `docs/operator/workflows/issue-248-wake-bus-implementation/` as a blocking finding.
...
Publish `docs/operator/artifacts/issue-248-wake-bus-implementation-v2/review/REVIEW.md` with:
