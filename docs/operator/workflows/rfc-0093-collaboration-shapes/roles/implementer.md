...
- Read `docs/operator/workflows/rfc-0093-collaboration-shapes/artifacts/DESIGN_SYNTHESIS.md`
...
- Write
  `docs/operator/workflows/rfc-0093-collaboration-shapes/artifacts/build/HANDOFF.md` with
