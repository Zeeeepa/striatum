...
session. Read
`docs/operator/workflows/rfc-0093-collaboration-shapes/artifacts/build/HANDOFF.md` and the
diff it points to.
...
(`docs/operator/workflows/rfc-0093-collaboration-shapes/artifacts/review/build/<lane>/REVIEW.md`).
