...
`docs/operator/workflows/rfc-0093-collaboration-shapes/artifacts/design/`. Produce a single
...
`docs/operator/workflows/rfc-0093-collaboration-shapes/artifacts/design/`. Do not write
source code.
