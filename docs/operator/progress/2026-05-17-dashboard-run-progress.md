...
Remaining related work is outside this slice: harden workflow-upgrade unknown
PostgreSQL state, move the terminal dashboard off the legacy repo-local read
path, and continue Go status/dashboard DTO parity where concrete gaps remain.
