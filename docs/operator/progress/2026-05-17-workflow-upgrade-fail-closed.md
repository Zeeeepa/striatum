...
unknown. The legacy repo-local SQLite guard has been removed entirely from
this path, and the refusal applies to both normal harness-profile upgrades
and `--add-phases --apply`.
