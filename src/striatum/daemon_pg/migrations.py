...
MIGRATIONS: tuple[PgMigration, ...] = (
    ...
    PgMigration(9, "blob storage references (RFC 0072)", "0009_blob_storage.sql"),
    PgMigration(
        10,
    ...
    PgMigration(
        14,
        "auto-finalize circuit breakers (TODO 56)",
        "0014_auto_finalize_circuit_breakers.sql",
    ),
)
