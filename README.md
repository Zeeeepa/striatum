...
├────────────────────────────────────────────────────────────────┤
│       Postgres striatumd schema (runtime schema 46 / owner 0022)│
...
| Schema | Managed by Go runtime migrations and owner bundles; current source is `go/pkg/db/migrations.go` (runtime schema 46), `go/pkg/db/owner.go` (owner bundle 0022), and `docs/reference/spec.md` |
