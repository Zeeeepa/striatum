...
- `dogfoods/rfc-0101-l2-conformance/artifacts/DESIGN_SYNTHESIS.md` — build to this.
- `dogfoods/rfc-0101-l2-conformance/artifacts/review/design/*/REVIEW.md` — the
...
- Stay inside `write_scope.allowed_paths`
  (`dogfoods/rfc-0101-l2-conformance/artifacts/build/`, `go/`, `docs/rfcs/`).
...
Write `dogfoods/rfc-0101-l2-conformance/artifacts/build/HANDOFF.md`: exactly
