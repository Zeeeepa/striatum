...
var commands = []Command{
	...
	{Command: "records", Subcommand: "migration", Rationale: "records migration inventory is a read-only filesystem dry-run that emits a deterministic historical-record manifest without daemon writes"},
