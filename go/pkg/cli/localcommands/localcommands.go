...
var commands = []Command{
	...
	{Command: "operator", Subcommand: "bootstrap", Rationale: "operator bootstrap is a bounded read-only startup composite over daemon reads plus local repository and documentation probes; it creates no new live state"},
